...
const video = document.getElementById('videoAd');
  ...
  function actualizar_foto_visor() {
    ...
    if (!imagen) {
      console.error("❌ Elemento #imagen_foto_proyecto no encontrado");
      return;
    }
  ...
  function alternar_autoplay_visor() {
    ...
    if (boton) {
      ...
      console.warn("⚠️ Botón de autoplay no encontrado");
    }
  }
  ...
  if (visor) {
    ...
    console.warn("⚠️ Elemento #contenedor_visor_fotos no encontrado para swipe");
  }
